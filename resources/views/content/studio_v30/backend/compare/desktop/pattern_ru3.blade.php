                        ...
                        <tbody>   
                            ...
                            @forelse ($data as $row)
                                <tr>
                                    ...
                                    <td class="text-center border-start"> 
                                        {{$row->pre_home_under_35_odd}} 
                                        
                                        <br/>

                                        @if(!is_null($row->goals_home) )
                                            @if($row->goals_home > $row->goals_away && ($row->goals_home + $row->goals_away < 4) ) 
                                                <div class="mt-1
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->pre_home_under_35_odd) )
                                            {{ ($row->pre_home_under_35_odd + $row->pre_draw_under_35_odd + $row->pre_away_under_35_odd )}}
                                        @endif  
                                    </td> 
 

                                    <td class="text-center border-start"> 
                                        {{$row->end_home_under_35_odd}} 
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->end_home_under_35_odd) )
                                            {{ ($row->end_home_under_35_odd + $row->end_draw_under_35_odd + $row->end_away_under_35_odd )}}  
                                        @endif
                                    </td> 
 
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_home_under_35_odd) && !is_null($row->end_home_under_35_odd) )
                                            {{ number_format(($row->end_home_under_35_odd - $row->pre_home_under_35_odd ),2,".",",") }} 
                                        @endif
                                    ...
                                    <td class="text-center border-start">  
                                        @if(!is_null($row->pre_draw_under_35_odd) && !is_null($row->end_draw_under_35_odd) )
                                            {{ number_format(($row->end_draw_under_35_odd - $row->pre_draw_under_35_odd ),2,".",",") }} 
                                        @endif
                                    ...
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_away_under_35_odd) && !is_null($row->end_away_under_35_odd) )
                                            {{ number_format(($row->end_away_under_35_odd - $row->pre_away_under_35_odd ),2,".",",") }} 
                                        @endif
