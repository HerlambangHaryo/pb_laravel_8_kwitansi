                    ...
                    <table id="datatableDefault" class="table table-dark"
                        ...
                        <thead class="table-dark">
                            <tr>               
                                ...
                                <x-html.th-content title="1x" /> 
                                <x-html.th-content title="12" /> 
                                <x-html.th-content title="2x" /> 
                        ...
                        <tbody>   
                            ...
                            @forelse ($data as $row)
                                <tr>
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->pre_dc_home_draw) )
                                            {{ ($row->pre_dc_home_draw + $row->pre_dc_home_away + $row->pre_dc_away_draw )}}
                                        @endif  
                                    </td> 
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->end_dc_home_draw) )
                                            {{ ($row->end_dc_home_draw + $row->end_dc_home_away + $row->end_dc_away_draw )}}
                                        @endif  
                                    </td> 
 
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_dc_home_draw) && !is_null($row->end_dc_home_draw) )
                                            {{ number_format(($row->end_dc_home_draw - $row->pre_dc_home_draw ),2,".",",") }} 
                                        @endif
                                    ...
                                    <td class="text-center border-start">  
                                        @if(!is_null($row->pre_dc_home_away) && !is_null($row->end_dc_home_away) )
                                            {{ number_format(($row->end_dc_home_away - $row->pre_dc_home_away ),2,".",",") }} 
                                        @endif
                                    ...
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_dc_away_draw) && !is_null($row->end_dc_away_draw) )
                                            {{ number_format(($row->end_dc_away_draw - $row->pre_dc_away_draw ),2,".",",") }} 
                                        @endif
