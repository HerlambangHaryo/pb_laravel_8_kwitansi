...
@section('content')  
    ...
    <div class="row mb-4">
        <div class="col-12 text-center">   
            ...
            <a href="{{ route('Notstarted.date', date('Y-m-d', strtotime($date . ' - 1 day')) ) }}" 
                class="btn btn-default btn-sm active" >  
                Yesterday
            </a>   
            ...
            <a href="{{ route('Notstarted.date', date('Y-m-d', strtotime($date)) ) }}" 
                class="btn btn-default btn-sm active" >  
            ...
            <a href="{{ route('Notstarted.date', date('Y-m-d', strtotime($date . ' + 2 day')) ) }}" 
                class="btn btn-default btn-sm" >  
    ...
    <div class="row mb-4">
        <div class="col-12 text-center">   
            <a href="{{ route('Model_one.date', $date) }}" 
                class="btn btn-default btn-sm" >
                <i class="fas fa-dice-one"></i>  
                Model One
            </a>  

            <a href="{{ route('Tipster.date', $date) }}" 
                class="btn btn-default btn-sm" >
                <i class="fas fa-user-secret"></i>
                Tipster
            </a>     

            <a href="{{ route('Notstarted.leaguegroup', $date) }}" 
                class="btn btn-default btn-sm" >  
                League Group
            </a>     

            <a href="{{ route('Notstarted.leaguehour', $date) }}" 
                class="btn btn-default btn-sm" >  
                League Hour
            </a>     
