...
<form class="col-12" action="{{ route($content.'.update', $Bantukamiapproval->id ) }}" method="POST" >
    @csrf 
    @method('PUT')
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-8">
                    <input type="text" 
                        ...
                        value       = "{{ old('bencana', $Bantukamiapproval->bencana) }}" 
                        disabled
                    />                            
                    @error('bencana')
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-8">
                    <input type="text" 
                        ...
                        value       = "{{ old('provinsi', $Bantukamiapproval->provinsi) }}"   
                        disabled
                    />                            
                    @error('provinsi')
                        <div class="invalid-feedback">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-8">
                    <input type="text" 
                        ...
                        value       = "{{ old('kota', $Bantukamiapproval->kota) }}"   
                        disabled
                    />                            
                    @error('kota')
                        <div class="invalid-feedback">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-8">
                    <input type="text" 
                        ...
                        value       = "{{ old('kecamatan', $Bantukamiapproval->kecamatan) }}"   
                        disabled
                    />                            
                    @error('kecamatan')
                        <div class="invalid-feedback">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-8">
                    <input type="text" 
                        ...
                        value       = "{{ old('kelurahan', $Bantukamiapproval->kelurahan) }}"   
                        disabled
                    />                            
                    @error('kelurahan')
                        <div class="invalid-feedback">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-8">
                    <input type="file" 
                        ...
                        value       = "{{ old('file', $Bantukamiapproval->file) }}" 
                        disabled
                    />                            
                    @error('foto')
                        <div class="invalid-feedback">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-8">
                    <input type="text" 
                        ...
                        value       = "{{ old('deskripsi', $Bantukamiapproval->deskripsi) }}" 
                        disabled  
