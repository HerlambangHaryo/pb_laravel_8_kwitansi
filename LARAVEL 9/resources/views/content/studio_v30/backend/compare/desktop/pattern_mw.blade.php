                        ...
                        <tbody>   
                            ...
                            @forelse ($data as $row)
                                <tr>
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->pre_mw_home_odd) )
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->end_mw_home_odd) )
                                            {{ ($row->end_mw_home_odd + $row->end_mw_draw_odd + $row->end_mw_away_odd )}}  
                                        @endif
                                    </td> 
 
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_mw_home_odd) && !is_null($row->end_mw_home_odd) )
                                            {{ number_format(($row->end_mw_home_odd - $row->pre_mw_home_odd ),2,".",",") }} 
                                        @endif
                                    ...
                                    <td class="text-center border-start">  
                                        @if(!is_null($row->pre_mw_draw_odd) && !is_null($row->end_mw_draw_odd) )
                                            {{ number_format(($row->end_mw_draw_odd - $row->pre_mw_draw_odd ),2,".",",") }} 
                                        @endif
                                    ...
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_mw_away_odd) && !is_null($row->end_mw_away_odd) )
                                            {{ number_format(($row->end_mw_away_odd - $row->pre_mw_away_odd ),2,".",",") }} 
                                        @endif
