                        ...
                        <tbody>   
                            ...
                            @forelse ($data as $row)
                                <tr>
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->pre_home_over_35_odd) )
                                            {{ ($row->pre_home_over_35_odd + $row->pre_draw_over_35_odd + $row->pre_away_over_35_odd )}}
                                        @endif  
                                    </td> 
 

                                    <td class="text-center border-start"> 
                                        {{$row->end_home_over_35_odd}} 
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->end_home_over_35_odd) )
                                            {{ ($row->end_home_over_35_odd + $row->end_draw_over_35_odd + $row->end_away_over_35_odd )}}  
                                        @endif
                                    </td> 
 
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_home_over_35_odd) && !is_null($row->end_home_over_35_odd) )
                                            {{ number_format(($row->end_home_over_35_odd - $row->pre_home_over_35_odd ),2,".",",") }} 
                                        @endif
                                    ...
                                    <td class="text-center border-start">  
                                        @if(!is_null($row->pre_draw_over_35_odd) && !is_null($row->end_draw_over_35_odd) )
                                            {{ number_format(($row->end_draw_over_35_odd - $row->pre_draw_over_35_odd ),2,".",",") }} 
                                        @endif
                                    ...
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_away_over_35_odd) && !is_null($row->end_away_over_35_odd) )
                                            {{ number_format(($row->end_away_over_35_odd - $row->pre_away_over_35_odd ),2,".",",") }} 
                                        @endif
