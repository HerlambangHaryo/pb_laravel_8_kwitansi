                        ...
                        <tbody>   
                            ...
                            @forelse ($data as $row)
                                <tr>
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->pre_csh_no) )
                                            {{ ($row->pre_csh_no + $row->pre_csa_no )}}
                                        @endif  
                                    </td> 
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->end_csh_no) )
                                            {{ ($row->end_csh_no + $row->end_csa_no )}}
                                        @endif  
                                    </td> 
 
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_csh_no) && !is_null($row->end_csh_no) )
                                            {{ number_format(($row->end_csh_no - $row->pre_csh_no ),2,".",",") }} 
                                        @endif
                                    ...
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_csa_no) && !is_null($row->end_csa_no) )
                                            {{ number_format(($row->end_csa_no - $row->pre_csa_no ),2,".",",") }} 
                                        @endif
