                    ...
                    <table id="datatableDefault" class="table table-dark"
                        ...
                        <thead class="table-dark">
                            <tr>               
                                ...
                                <x-html.th-content title="Yes" />  
                                <x-html.th-content title="no" /> 
                        ...
                        <tbody>   
                            ...
                            @forelse ($data as $row)
                                <tr>
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->pre_btts_yes) )
                                            {{ ($row->pre_btts_yes + $row->pre_btts_no )}}
                                        @endif  
                                    </td> 
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->end_btts_yes) )
                                            {{ ($row->end_btts_yes + $row->end_btts_no )}}
                                        @endif  
                                    </td> 
 
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_btts_yes) && !is_null($row->end_btts_yes) )
                                            {{ number_format(($row->end_btts_yes - $row->pre_btts_yes ),2,".",",") }} 
                                        @endif
                                    ...
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_btts_no) && !is_null($row->end_btts_no) )
                                            {{ number_format(($row->end_btts_no - $row->pre_btts_no ),2,".",",") }} 
                                        @endif
