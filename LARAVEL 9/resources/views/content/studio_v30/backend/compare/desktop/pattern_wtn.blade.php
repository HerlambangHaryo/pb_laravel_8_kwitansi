                        ...
                        <tbody>   
                            ...
                            @forelse ($data as $row)
                                <tr>
                                    ...
                                    <td class="text-center border-start"> 
                                        {{$row->pre_away_win_to_nil_odd}} 
                                        
                                        <br/>

                                        @if(!is_null($row->goals_home) )
                                            @if($row->goals_home < $row->goals_away && $row->goals_home == 0) 
                                                <div class="mt-1
                                                    @if($row->goals_home < $row->goals_away && $row->goals_home == 0) 
                                                        bg-success 
                                                    @endif ">
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->pre_home_win_to_nil_odd) )
                                            {{ ($row->pre_home_win_to_nil_odd + $row->pre_away_win_to_nil_odd )}}
                                        @endif  
                                    </td> 
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->end_home_win_to_nil_odd) )
                                            {{ ($row->end_home_win_to_nil_odd + $row->end_away_win_to_nil_odd )}}
                                        @endif  
                                    </td> 
 
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_home_win_to_nil_odd) && !is_null($row->end_home_win_to_nil_odd) )
                                            {{ number_format(($row->end_home_win_to_nil_odd - $row->pre_home_win_to_nil_odd ),2,".",",") }} 
                                        @endif
                                    ...
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_away_win_to_nil_odd) && !is_null($row->end_away_win_to_nil_odd) )
                                            {{ number_format(($row->end_away_win_to_nil_odd - $row->pre_away_win_to_nil_odd ),2,".",",") }} 
                                        @endif
