                                ...
                                <tr>
                                    ...
                                    <td class="text-center border-start">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <?php
                                                $row->score_halftime_home = $row->score_halftime_home; 
                                    ...
                                    <td class="text-center ">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <?php
                                                $row->score_halftime_away = $row->score_halftime_away; 
                                    ...
                                    <td class="text-center border-start"> 
                                        {{$row->pre_home_win_either_half_odd}} 
                                    ...
                                    <td class="text-center border-start"> 
                                        {{$row->pre_away_win_either_half_odd}} 
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->pre_home_win_either_half_odd) )
                                            {{ ($row->pre_home_win_either_half_odd + $row->pre_away_win_either_half_odd )}}
                                        @endif  
                                    </td> 
                                    ...
                                    <td class="text-center border-start"> 
                                        {{$row->end_home_win_either_half_odd}} 
                                    ...
                                    <td class="text-center border-start"> 
                                        {{$row->end_away_win_either_half_odd}} 
                                    ...
                                    <td class="bg-gray-800 text-center border-start"> 
                                        @if(!is_null($row->end_home_win_either_half_odd) )
                                            {{ ($row->end_home_win_either_half_odd + $row->end_away_win_either_half_odd )}}
                                        @endif  
                                    </td> 
 
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_home_win_either_half_odd) && !is_null($row->end_home_win_either_half_odd) )
                                            {{ number_format(($row->end_home_win_either_half_odd - $row->pre_home_win_either_half_odd ),2,".",",") }} 
                                        @endif
                                    ...
                                    <td class="text-center border-start"> 
                                        @if(!is_null($row->pre_away_win_either_half_odd) && !is_null($row->end_away_win_either_half_odd) )
                                            {{ number_format(($row->end_away_win_either_half_odd - $row->pre_away_win_either_half_odd ),2,".",",") }} 
                                        @endif
